/**
 * Loading-screen quips shown while a long-running stage works.
 * Shown one at a time, rotating, so a slow audit has a bit of personality.
 */
...
/** Pick a random starting quip so repeat runs do not feel identical. */
export function randomQuipIndex(): number {
